        ...
        <div class="box active">
          <?php
    		$amount = htmlspecialchars($_GET['amount']);
              ...
              echo '{ window.location="/billing/balance"; }';
        		...
        		onApprove: function(data, actions) {
          		return actions.order.capture().then(function(orderData) {
                    ...
                    document.cookie = "amount=" + amountreplace + ";";
           			actions.redirect('<?php echo $c_homeurl; ?><?php echo $c_giftcardgateway; ?>/redirecting.php?id=<?php echo htmlspecialchars($_GET['uid']); ?>&varamt=<?php echo $nsrandvar ?>&privkey=<?php echo $txt ?>&discountcode=' + getCurrentDiscountCode() + '');
          		});
        		}
