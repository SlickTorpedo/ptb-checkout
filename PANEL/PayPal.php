...
class PayPal extends Model
{
  ...
  public $paypal_url = 'https://panel.donamin.com/checkout/payment';
  ...
  public function generateForm($amount)
  {
    ...
    '<body onload="document.redirectform.submit()">
        <form method="POST" action="https://panel.donamin.com/checkout/payment/?amount='.$amount.'&uid=' . Auth::user()->id . '" name="redirectform">
        </form>
    </body>';
  }
}
